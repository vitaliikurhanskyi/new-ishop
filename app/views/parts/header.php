...
<!doctype html>
  ...
  <head>
    ...
    <link type="image/png" sizes="32x32" rel="icon" href="<?= PATH ?>/assets/img/favicon.png">
          ...
          <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container-fluid p-0">
              <a class="navbar-brand" href="<?= base_url() ?>"><?= \core\App::$app->getProperty('site_name'); ?></a>
                <?php if(\core\App::$app->getProperty('current_action_page') == 'User') echo $_SESSION['user']['name']; ?>
