            ...
            <form class="row g-3" method="post">
                ...
                <div class="col-md-6 offset-md-3">
                    <div class="form-floating mb-3">
                        <input type="email" name="email" class="form-control" id="email" placeholder="name@example.com" value="<?= htmlchars($_SESSION['user']['email']) ?>" disabled>
                ...
                <div class="col-md-6 offset-md-3">
                    <div class="form-floating mb-3">
                        <input type="text" name="name" class="form-control" id="name" placeholder="Name" value="<?= htmlchars($_SESSION['user']['name']) ?>" required>
                ...
                <div class="col-md-6 offset-md-3">
                    <div class="form-floating mb-3">
                        <input type="text" name="address" class="form-control" id="addres" placeholder="Address" value="<?= htmlchars($_SESSION['user']['address']) ?>" required>
